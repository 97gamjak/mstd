...
TEST_CASE("Enum indexing works for packs and dims")
{
    ...
    STATIC_REQUIRE(d::si_exp<SIDimId::Length> == 1);
    STATIC_REQUIRE(d::si_exp<SIDimId::Mass> == 2);
    STATIC_REQUIRE(d::si_exp<SIDimId::Time> == 3);
    STATIC_REQUIRE(d::si_exp<SIDimId::Current> == 4);
    STATIC_REQUIRE(d::si_exp<SIDimId::Temperature> == 5);
    STATIC_REQUIRE(d::si_exp<SIDimId::Amount> == 6);
    STATIC_REQUIRE(d::si_exp<SIDimId::Luminous> == 7);

    STATIC_REQUIRE(d::ex_exp<ExtraDimId::Angle> == 8);
    STATIC_REQUIRE(d::ex_exp<ExtraDimId::Currency> == 9);
    STATIC_REQUIRE(d::ex_exp<ExtraDimId::Info> == 10);
}
...
TEST_CASE("dim_div_t basic cases")
{
    ...
    STATIC_REQUIRE(same<back_to_A, A>);
}
...
TEST_CASE("dim_pow_t powers and identities")
{
    ...
    STATIC_REQUIRE(same<any0, dim_scalar>);
}
...
TEST_CASE("Dimensionless detection")
{
    ...
    STATIC_REQUIRE(is_dimensionless_v<dimLess1>);
    STATIC_REQUIRE(is_dimensionless_v<dimLess2>);

    using A = dim_angle;
    STATIC_REQUIRE(!is_dimensionless_v<A>);
}
